...
for file in glob.glob('./stripped/*'):
       	...
       	val=alpha_helical_content(t,range(153,160)) #AtD14
        #val=alpha_helical_content(t,range(155,162)) #ShHTL7
       	np.save('./analysis/'+file.split('/')[-1]+'_ftr-alpha-helical-content-unfolded.npy',val)
