...
def run_pipeline(feat_all, lag_time, tica_components, n_clusters):
    ...
    #pyemma.plots.plot_implied_timescales(its_object, outfile="its_plot.png", units='ns', dt=0.7)
    ...
    #msm_object = pyemma.msm.estimate_markov_model(dtrajs, lag_time, dt_traj='700 ps', score_method='VAMP1', score_k=10)
...
if __name__=="__main__":
    ...
    #column_ind = calc_oasis(ft_all, n_components=80)
    ...
    try:
        ...
        #top="../stripped.4ih4_modelled_active.prmtop"
        top="../stripped.AtD14_D218A_apo.prmtop"
        #top="../stripped.ShHTL7_apo_active.prmtop"
        #print(traj_list)
